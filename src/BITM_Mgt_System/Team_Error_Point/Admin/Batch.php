...
class Batch extends Database
{
    ...
    public function setData($postArray){
        ...
        if(array_key_exists("course_id",$postArray)){
            $this->course_id = $postArray['course_id'];
        }

        if(array_key_exists("batch_name",$postArray)){
            $this->batch_name = $postArray['batch_name'];
        }
    ...
    public function view(){
        ...
        $query = "SELECT * FROM `tbl_batches` WHERE `id`=".$this->id;
    ...
    public function update(){
        ...
        $query = "UPDATE `tbl_batches` SET `batch` = ? WHERE `id` = $this->id;";

        //Utility::dd($query);

        $dataArray = array($this->batch_name);
    ...
    public function delete(){
        $query = "DELETE FROM `tbl_batches` WHERE `id` = $this->id;";
