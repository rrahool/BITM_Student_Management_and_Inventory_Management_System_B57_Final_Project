...
if($status) {
    ...
    $batchClass = $auth->setData($_POST)->check_batchHasClassToday();
    ...
    if (!$batchClass) {
        ...
        Message::message("
                <div class=\"alert alert-danger\">
                        <h6>
                            <strong>Sorry!</strong> Your Batch has no Classes Today.
                        </h6>
    ...
    Message::message("
                <div class=\"alert alert-danger\">
                        <h6>
                            <strong>Wrong Information!</strong> SEID or Email Doesn't Matched or Exists.
                        </h6>
                </div>");
