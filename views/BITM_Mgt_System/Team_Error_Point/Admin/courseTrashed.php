        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="w3-bar w3-border w3-light-grey">
                        <a href="create.php" class="w3-bar-item w3-button" style="text-decoration: none">Add City</a>
                        <a href="index.php" class="w3-bar-item w3-button" style="text-decoration: none">City List</a>
                        <a href="courseTrashed.php" class="w3-bar-item w3-button w3-black" style="text-decoration: none">Trash List</a>
            ...
            <div class="row" align="center">
                ...
                <div class="pagination">
                    ...
                    if($page>$pages)
                        Utility::redirect("courseTrashed.php?Page=$pages");

                    if($page>1)
                        echo "<a href='courseTrashed.php?Page=$pageMinusOne'>" . "&laquo;" . "</a>";
                    ...
                    if($page<$pages)
                        echo "<a href='courseTrashed.php?Page=$pagePlusOne'>" . "&raquo;" . "</a>";
